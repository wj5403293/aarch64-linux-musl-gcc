...
enum opt_code
{
  ...
  OPT__param_destructive_interference_size_ = 110,/* --param=destructive-interference-size= */
  OPT__param_dse_max_alias_queries_per_store_ = 111,/* --param=dse-max-alias-queries-per-store= */
  OPT__param_dse_max_object_size_ = 112,     /* --param=dse-max-object-size= */
  OPT__param_early_inlining_insns_ = 113,    /* --param=early-inlining-insns= */
  OPT__param_fsm_scale_path_stmts_ = 114,    /* --param=fsm-scale-path-stmts= */
  OPT__param_fully_pipelined_fma_ = 115,     /* --param=fully-pipelined-fma= */
  OPT__param_gcse_after_reload_critical_fraction_ = 116,/* --param=gcse-after-reload-critical-fraction= */
  OPT__param_gcse_after_reload_partial_fraction_ = 117,/* --param=gcse-after-reload-partial-fraction= */
  OPT__param_gcse_cost_distance_ratio_ = 118,/* --param=gcse-cost-distance-ratio= */
  OPT__param_gcse_unrestricted_cost_ = 119,  /* --param=gcse-unrestricted-cost= */
  OPT__param_ggc_min_expand_ = 120,          /* --param=ggc-min-expand= */
  OPT__param_ggc_min_heapsize_ = 121,        /* --param=ggc-min-heapsize= */
  OPT__param_gimple_fe_computed_hot_bb_threshold_ = 122,/* --param=gimple-fe-computed-hot-bb-threshold= */
  OPT__param_graphite_allow_codegen_errors_ = 123,/* --param=graphite-allow-codegen-errors= */
  OPT__param_graphite_max_arrays_per_scop_ = 124,/* --param=graphite-max-arrays-per-scop= */
  OPT__param_graphite_max_nb_scop_params_ = 125,/* --param=graphite-max-nb-scop-params= */
  OPT__param_hardcfr_max_blocks_ = 126,      /* --param=hardcfr-max-blocks= */
  OPT__param_hardcfr_max_inline_blocks_ = 127,/* --param=hardcfr-max-inline-blocks= */
  OPT__param_hash_table_verification_limit_ = 128,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 129,   /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 130,/* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 131,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hwasan_instrument_allocas_ = 132,/* --param=hwasan-instrument-allocas= */
  OPT__param_hwasan_instrument_mem_intrinsics_ = 133,/* --param=hwasan-instrument-mem-intrinsics= */
  OPT__param_hwasan_instrument_reads_ = 134, /* --param=hwasan-instrument-reads= */
  OPT__param_hwasan_instrument_stack_ = 135, /* --param=hwasan-instrument-stack= */
  OPT__param_hwasan_instrument_writes_ = 136,/* --param=hwasan-instrument-writes= */
  OPT__param_hwasan_random_frame_tag_ = 137, /* --param=hwasan-random-frame-tag= */
  OPT__param_inline_heuristics_hint_percent_ = 138,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 139,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 140,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 141,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 142,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_large_unit_insns_ = 143, /* --param=ipa-cp-large-unit-insns= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 144,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 145,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 146,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_profile_count_base_ = 147,/* --param=ipa-cp-profile-count-base= */
  OPT__param_ipa_cp_recursion_penalty_ = 148,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 149,/* --param=ipa-cp-recursive-freq-factor= */
  OPT__param_ipa_cp_single_call_penalty_ = 150,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 151,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 152,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_jump_function_lookups_ = 153,/* --param=ipa-jump-function-lookups= */
  OPT__param_ipa_max_aa_steps_ = 154,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 155,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_loop_predicates_ = 156, /* --param=ipa-max-loop-predicates= */
  OPT__param_ipa_max_param_expr_ops_ = 157,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 158,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_deref_prob_threshold_ = 159,/* --param=ipa-sra-deref-prob-threshold= */
  OPT__param_ipa_sra_max_replacements_ = 160,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 161,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipa_sra_ptrwrap_growth_factor_ = 162,/* --param=ipa-sra-ptrwrap-growth-factor= */
  OPT__param_ira_consider_dup_in_all_alts_ = 163,/* --param=ira-consider-dup-in-all-alts= */
  OPT__param_ira_loop_reserved_regs_ = 164,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 165,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 166,       /* --param=ira-max-loops-num= */
  OPT__param_ira_simple_lra_insn_threshold_ = 167,/* --param=ira-simple-lra-insn-threshold= */
  OPT__param_iv_always_prune_cand_set_bound_ = 168,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 169,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 170,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 171,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 172,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 173,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 174,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 175,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 176,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 177,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 178,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 179,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 180,        /* --param=large-unit-insns= */
  OPT__param_lazy_modules_ = 181,            /* --param=lazy-modules= */
  OPT__param_lim_expensive_ = 182,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 183,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 184,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 185,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 186,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 187,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 188,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 189,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 190,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 191,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 192,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_partition_ = 193,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 194,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 195,       /* --param=lto-min-partition= */
  OPT__param_lto_partitions_ = 196,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 197,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 198,       /* --param=max-combine-insns= */
  ...
  OPT__param_max_dse_active_local_stores_ = 209,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 210,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 211,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 212,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 213,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 214,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 215,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 216,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 217,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 218,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 219,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 220,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 221,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 222,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 223,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 224, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 225,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 226,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 227,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 228,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 229,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 230,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 231, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 232,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 233,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 234,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 235,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 236,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 237,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 238,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 239,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 240,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 241, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 242,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 243,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 244,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 245,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 246, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 247,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 248,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 249,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 250,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 251,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 252,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 253, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 254,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 255,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 256,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 257,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 258,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 259,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 260,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 261,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 262,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 263,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 264,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 265,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 266,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 267,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 268,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 269,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 270,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 271, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 272,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 273,       /* --param=max-vartrack-size= */
  OPT__param_min_crossjump_insns_ = 274,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 275,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 276,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 277,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 278,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 279,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 280,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 281,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 282,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 283,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 284,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 285,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 286,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 287,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 288,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 289,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 290,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 291,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 292,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 293, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 294,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 295,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 296,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 297,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 298,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 299,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 300,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 301, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 302,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 303,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 304,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 305,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 306,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 307,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 308,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 309,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 310,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 311,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 312, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 313,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 314,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 315,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 316,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 317,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 318,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 319, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 320,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 321,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 322,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 323,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 324,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 325,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 326,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 327,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 328,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 329,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 330,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 331,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 332,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 333,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 334,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_threader_debug_ = 335,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 336,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 337,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 338, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 339,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 340,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 341,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 342, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 343,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 344,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 345,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 346,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 347,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 348,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 349,   /* --param=uninit-max-num-chains= */
  ...
  OPT_Wextra = 647,                          /* -Wextra */
  OPT_Wextra_semi = 648,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 649,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 650,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 651,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 652,                    /* -Wfloat-equal */
  /* OPT_Wformat = 653, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 654,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 655,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 656,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 657,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 658, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 659,               /* -Wformat-overflow= */
  OPT_Wformat_security = 660,                /* -Wformat-security */
  OPT_Wformat_signedness = 661,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 662, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 663,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 664,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 665,             /* -Wformat-zero-length */
  OPT_Wformat_ = 666,                        /* -Wformat= */
  OPT_Wframe_address = 667,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 668,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 669,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 670,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 671,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 672,                  /* -Wglobal-module */
  OPT_Whardened = 673,                       /* -Whardened */
  OPT_Wheader_guard = 674,                   /* -Wheader-guard */
  /* OPT_Whsa = 675, */                      /* -Whsa */
  OPT_Wif_not_aligned = 676,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 677,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 678,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 679,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 680, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 681,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 682,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 683,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 684,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 685,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 686, */                   /* -Wimport */
  OPT_Winaccessible_base = 687,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 688,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 689,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 690,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 691,             /* -Winit-list-lifetime */
  OPT_Winit_self = 692,                      /* -Winit-self */
  OPT_Winline = 693,                         /* -Winline */
  OPT_Wint_conversion = 694,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 695,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 696,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 697,               /* -Winteger-division */
  OPT_Winterference_size = 698,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 699,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 700,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 701,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 702,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 703,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 704,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 705,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 706,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 707,               /* -Wjump-misses-init */
  OPT_Wl_ = 708,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 709, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 710,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 711,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 712,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 713,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 714,                     /* -Wlogical-op */
  OPT_Wlong_long = 715,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 716,              /* -Wlto-type-mismatch */
  OPT_Wmain = 717,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 718,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 719,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 720,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 721,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 722,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 723,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 724,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 725,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 726,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 727,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 728,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 729,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 730, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 731,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 732, */         /* -Wmissing-noreturn */
  ...
  OPT_Wtemplates = 880,                      /* -Wtemplates */
  OPT_Wterminate = 881,                      /* -Wterminate */
  OPT_Wtraditional = 882,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 883,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 884, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 885,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 886,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 887,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 888,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 889,                           /* -Wtsan */
  OPT_Wtype_limits = 890,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 891,            /* -Wundeclared-selector */
  OPT_Wundef = 892,                          /* -Wundef */
  OPT_Wundefined_do_loop = 893,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 894,                      /* -Wunderflow */
  OPT_Wunicode = 895,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 896,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 897,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 898,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 899,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 900, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 901, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 902,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 903,/* -Wunterminated-string-initialization */
  OPT_Wunused = 904,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 905,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 906,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 907, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 908,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 909,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 910,                /* -Wunused-function */
  OPT_Wunused_label = 911,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 912,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 913,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 914,               /* -Wunused-parameter */
  OPT_Wunused_result = 915,                  /* -Wunused-result */
  OPT_Wunused_value = 916,                   /* -Wunused-value */
  OPT_Wunused_variable = 917,                /* -Wunused-variable */
  OPT_Wuse_after_free = 918,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 919,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 920,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 921,                   /* -Wuseless-cast */
  OPT_Wvarargs = 922,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 923,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 924,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 925,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 926,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 927,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 928,            /* -Wvirtual-move-assign */
  OPT_Wvla = 929,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 930,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 931,                  /* -Wvla-parameter */
  OPT_Wvolatile = 932,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 933,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 934,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 935,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 936,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 937,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 938,                       /* -Wzerotrip */
  OPT_X = 939,                               /* -X */
  OPT_Xassembler = 940,                      /* -Xassembler */
  OPT_Xf = 941,                              /* -Xf */
  OPT_Xlinker = 942,                         /* -Xlinker */
  OPT_Xpreprocessor = 943,                   /* -Xpreprocessor */
  OPT_Z = 944,                               /* -Z */
  OPT_ansi = 945,                            /* -ansi */
  OPT_aux_info = 946,                        /* -aux-info */
  /* OPT_aux_info_ = 947, */                 /* -aux-info= */
  OPT_c = 948,                               /* -c */
  OPT_callgraph = 949,                       /* -callgraph */
  OPT_coverage = 950,                        /* -coverage */
  OPT_cpp = 951,                             /* -cpp */
  OPT_cpp_ = 952,                            /* -cpp= */
  OPT_d = 953,                               /* -d */
  OPT_debuglib_ = 954,                       /* -debuglib= */
  OPT_defaultlib_ = 955,                     /* -defaultlib= */
  OPT_defined_only = 956,                    /* -defined-only */
  OPT_demangle = 957,                        /* -demangle */
  OPT_dstartfiles = 958,                     /* -dstartfiles */
  OPT_dump_body_ = 959,                      /* -dump-body= */
  OPT_dump_level_ = 960,                     /* -dump-level= */
  OPT_dumpbase = 961,                        /* -dumpbase */
  OPT_dumpbase_ext = 962,                    /* -dumpbase-ext */
  OPT_dumpdir = 963,                         /* -dumpdir */
  OPT_dumpfullversion = 964,                 /* -dumpfullversion */
  OPT_dumpmachine = 965,                     /* -dumpmachine */
  OPT_dumpspecs = 966,                       /* -dumpspecs */
  OPT_dumpversion = 967,                     /* -dumpversion */
  OPT_e = 968,                               /* -e */
  OPT_export_dynamic = 969,                  /* -export-dynamic */
  OPT_fPIC = 970,                            /* -fPIC */
  OPT_fPIE = 971,                            /* -fPIE */
  OPT_fRTS_ = 972,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 973,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 974,                   /* -fabi-version= */
  OPT_faccess_control = 975,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 976,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 977,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 978,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 979,                  /* -falign-commons */
  OPT_falign_functions = 980,                /* -falign-functions */
  OPT_falign_functions_ = 981,               /* -falign-functions= */
  OPT_falign_jumps = 982,                    /* -falign-jumps */
  OPT_falign_jumps_ = 983,                   /* -falign-jumps= */
  OPT_falign_labels = 984,                   /* -falign-labels */
  OPT_falign_labels_ = 985,                  /* -falign-labels= */
  OPT_falign_loops = 986,                    /* -falign-loops */
  OPT_falign_loops_ = 987,                   /* -falign-loops= */
  /* OPT_faligned_new = 988, */              /* -faligned-new */
  OPT_faligned_new_ = 989,                   /* -faligned-new= */
  OPT_fall_instantiations = 990,             /* -fall-instantiations */
  OPT_fall_intrinsics = 991,                 /* -fall-intrinsics */
  OPT_fall_virtual = 992,                    /* -fall-virtual */
  OPT_fallocation_dce = 993,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 994,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 995,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 996,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 997, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 998,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 999,         /* -falt-external-templates */
  OPT_fanalyzer = 1000,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1001,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1002,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1003,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1004,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1005,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1006, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1007,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1008,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1009,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1010,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1011,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1012,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1013,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1014,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1015,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1016, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1017, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1018, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1019, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1020,           /* -fasan-shadow-offset= */
  OPT_fasm = 1021,                           /* -fasm */
  OPT_fassert = 1022,                        /* -fassert */
  OPT_fassociative_math = 1023,              /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 1024,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1025,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1026,                     /* -fauto-init */
  OPT_fauto_profile = 1027,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1028,                 /* -fauto-profile= */
  OPT_fautomatic = 1029,                     /* -fautomatic */
  OPT_fbackslash = 1030,                     /* -fbackslash */
  OPT_fbacktrace = 1031,                     /* -fbacktrace */
  OPT_fbit_tests = 1032,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1033,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1034,                        /* -fbounds */
  OPT_fbounds_check = 1035,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1036,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1037,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1038,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1039, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1040, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1041, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1042,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1043,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1044,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1045,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1046,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1047,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1048,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1049,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1050,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1051,                    /* -fcall-used- */
  OPT_fcaller_saves = 1052,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1053,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1054,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1055,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1056,      /* -fcanonical-system-headers */
  OPT_fcase = 1057,                          /* -fcase */
  /* OPT_fcf_protection = 1058, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1059,                /* -fcf-protection= */
  OPT_fchar8_t = 1060,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1061,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1062, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1063,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1064,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1065,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1066, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1067, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1068, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1069, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1070, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1071, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1072,                  /* -fcheckaction= */
  OPT_fchecking = 1073,                      /* -fchecking */
  OPT_fchecking_ = 1074,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1075,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1076,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1077,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1078,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1079,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1080,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1081,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1082,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1083,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1084,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1085,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1086,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1087,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1088,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1089,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1090,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1091,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1092,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1093, */                /* -fcilkplus */
  OPT_fcoarray_ = 1094,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1095,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1096,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1097,                        /* -fcommon */
  OPT_fcompare_debug = 1098,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1099,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1100,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1101,                  /* -fcompare-elim */
  OPT_fconcepts = 1102,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1103,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1104,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1105,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1106,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1107, */          /* -fconserve-space */
  OPT_fconserve_stack = 1108,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1109,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1110,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1111,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1112,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1113,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1114,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1115,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1116,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1117,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1118,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1119,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1120,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1121, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1122,                     /* -fcontracts */
  OPT_fconvert_ = 1123,                      /* -fconvert= */
  OPT_fcoroutines = 1124,                    /* -fcoroutines */
  OPT_fcpp = 1125,                           /* -fcpp */
  OPT_fcpp_begin = 1126,                     /* -fcpp-begin */
  OPT_fcpp_end = 1127,                       /* -fcpp-end */
  OPT_fcprop_registers = 1128,               /* -fcprop-registers */
  OPT_fcray_pointer = 1129,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1130,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1131,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1132, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1133,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1134,              /* -fcx-limited-range */
  OPT_fd = 1135,                             /* -fd */
  OPT_fd_lines_as_code = 1136,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1137,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1138,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1139,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1140,                      /* -fdbg-cnt= */
  OPT_fdce = 1141,                           /* -fdce */
  OPT_fdebug = 1142,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1143,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1144,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1145,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1146,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1147,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1148,           /* -fdebug-types-section */
  OPT_fdebug_ = 1149,                        /* -fdebug= */
  OPT_fdec = 1150,                           /* -fdec */
  OPT_fdec_blank_format_item = 1151,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1152,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1153,           /* -fdec-format-defaults */
  OPT_fdec_include = 1154,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1155,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1156,                      /* -fdec-math */
  OPT_fdec_static = 1157,                    /* -fdec-static */
  OPT_fdec_structure = 1158,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1159,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1160, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1161,                          /* -fdef= */
  OPT_fdefault_double_8 = 1162,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1163, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1164,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1165,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1166,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1167,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1168,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1169,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1170,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1171,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1172,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1173,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1174,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1175,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1176,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1177,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_all_candidates = 1178,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1179, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1180,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1181,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1182,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1183,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1184,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1185,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1186,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1187,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1188,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1189,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1190,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1191,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1192,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1193,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1194,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1195,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1196, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1197,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1198,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1199,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1200,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1201,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1202, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1203,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1204,               /* -fdirectives-only */
  OPT_fdisable_ = 1205,                      /* -fdisable- */
  OPT_fdoc = 1206,                           /* -fdoc */
  OPT_fdoc_dir_ = 1207,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1208,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1209,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1210,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1211,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1212,                      /* -fdruntime */
  OPT_fdse = 1213,                           /* -fdse */
  OPT_fdump_ = 1214,                         /* -fdump- */
  OPT_fdump_ada_spec = 1215,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1216,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1217,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1218,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1219,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1220,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1221,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1222,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1223,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1224,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1225,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1226,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1227,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1228,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1229,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1230,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1231,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1232,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1233, */               /* -fdump-core */
  OPT_fdump_d_original = 1234,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1235,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1236,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1237,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1238,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1239,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1240,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1241,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1242,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1243, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1244,                   /* -fdump-passes */
  OPT_fdump_scos = 1245,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1246,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1247,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1248,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1249,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1250,                /* -fearly-inlining */
  OPT_felide_constructors = 1251,            /* -felide-constructors */
  OPT_felide_type = 1252,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1253, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1254,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1255,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1256,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1257,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1258,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1259,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1260,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1261,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1262,                /* -fenum-int-equiv */
  OPT_fexceptions = 1263,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1264,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1265,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1266,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1267,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1268,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1269,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1270,               /* -fextended-opaque */
  OPT_fextern_std_ = 1271,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1272,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1273,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1274,            /* -fexternal-templates */
  OPT_ff2c = 1275,                           /* -ff2c */
  OPT_ffast_math = 1276,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1277,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1278,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1279,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1280,              /* -ffinite-math-only */
  OPT_ffixed_ = 1281,                        /* -ffixed- */
  OPT_ffixed_form = 1282,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1283,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1284,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1285,                   /* -ffloat-store */
  OPT_ffloatvalue = 1286,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1287,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1288,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1289,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1290, */              /* -fforce-addr */
  OPT_fforward_propagate = 1291,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1292,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1293,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1294,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1295,                     /* -ffpe-trap= */
  OPT_ffree_form = 1296,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1297,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1298,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1299,                  /* -ffreestanding */
  OPT_ffriend_injection = 1300,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1301,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1302,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1303,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1304,             /* -ffunction-sections */
  OPT_fgcse = 1305,                          /* -fgcse */
  OPT_fgcse_after_reload = 1306,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1307,                      /* -fgcse-las */
  OPT_fgcse_lm = 1308,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1309,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1310,              /* -fgen-module-list= */
  OPT_fgimple = 1311,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1312,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1313,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1314,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1315,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1316,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1317,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1318,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1319,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1320,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1321,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1322,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1323,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1324,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1325,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1326,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1327,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1328,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1329,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1330,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1331,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1332,                      /* -fgraphite */
  OPT_fgraphite_identity = 1333,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1334,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1335,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1336, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1337,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1338, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1339, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1340,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1341,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1342,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1343,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1344,                      /* -fhardened */
  /* OPT_fhelp = 1345, */                    /* -fhelp */
  /* OPT_fhelp_ = 1346, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1347,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1348,                     /* -fhonor-std */
  OPT_fhosted = 1349,                        /* -fhosted */
  OPT_fhuge_objects = 1350,                  /* -fhuge-objects */
  OPT_fident = 1351,                         /* -fident */
  OPT_fif_conversion = 1352,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1353,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1354,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1355,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1356,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1357,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1358,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1359,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1360,            /* -fimplicit-templates */
  OPT_findex = 1361,                         /* -findex */
  OPT_findirect_inlining = 1362,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1363,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1364,               /* -finit-character= */
  OPT_finit_derived = 1365,                  /* -finit-derived */
  OPT_finit_integer_ = 1366,                 /* -finit-integer= */
  OPT_finit_local_zero = 1367,               /* -finit-local-zero */
  OPT_finit_logical_ = 1368,                 /* -finit-logical= */
  OPT_finit_real_ = 1369,                    /* -finit-real= */
  OPT_finline = 1370,                        /* -finline */
  OPT_finline_arg_packing = 1371,            /* -finline-arg-packing */
  OPT_finline_atomics = 1372,                /* -finline-atomics */
  OPT_finline_functions = 1373,              /* -finline-functions */
  OPT_finline_functions_called_once = 1374,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1375,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1376,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1377, */           /* -finline-limit- */
  OPT_finline_limit_ = 1378,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1379,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1380,        /* -finline-small-functions */
  OPT_finline_stringops = 1381,              /* -finline-stringops */
  OPT_finline_stringops_ = 1382,             /* -finline-stringops= */
  OPT_finput_charset_ = 1383,                /* -finput-charset= */
  OPT_finstrument_functions = 1384,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1385,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1386,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1387,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1388,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1389,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1390,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1391,                    /* -finvariants */
  OPT_fipa_bit_cp = 1392,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1393,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1394, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1395,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1396,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1397,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1398,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1399, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1400,                    /* -fipa-modref */
  OPT_fipa_profile = 1401,                   /* -fipa-profile */
  OPT_fipa_pta = 1402,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1403,                /* -fipa-pure-const */
  OPT_fipa_ra = 1404,                        /* -fipa-ra */
  OPT_fipa_reference = 1405,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1406,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1407,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1408,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1409,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1410, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1411,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1412,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1413,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1414,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1415,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1416,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1417,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1418,                  /* -fira-verbose= */
  OPT_fiso = 1419,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1420,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1421,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1422,              /* -fivar-visibility= */
  OPT_fivopts = 1423,                        /* -fivopts */
  OPT_fjump_tables = 1424,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1425,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1426,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1427,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1428,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1429,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1430,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1431,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1432,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1433,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1434,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1435,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1436,            /* -flarge-source-files */
  OPT_flate_combine_instructions = 1437,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1438,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1439,            /* -fleading-underscore */
  OPT_flibs_ = 1440,                         /* -flibs= */
  OPT_flifetime_dse = 1441,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1442,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1443,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1444,                /* -flinker-output= */
  /* OPT_flive_patching = 1445, */           /* -flive-patching */
  OPT_flive_patching_ = 1446,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1447,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1448,                   /* -flocal-ivars */
  OPT_flocation_ = 1449,                     /* -flocation= */
  /* OPT_floop_block = 1450, */              /* -floop-block */
  /* OPT_floop_flatten = 1451, */            /* -floop-flatten */
  OPT_floop_interchange = 1452,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1453,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1454, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1455,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1456, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1457,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1458,                     /* -flra-remat */
  OPT_flto = 1459,                           /* -flto */
  OPT_flto_compression_level_ = 1460,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1461, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1462,                /* -flto-partition= */
  OPT_flto_report = 1463,                    /* -flto-report */
  OPT_flto_report_wpa = 1464,                /* -flto-report-wpa */
  OPT_flto_ = 1465,                          /* -flto= */
  OPT_fltrans = 1466,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1467,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1468,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1469,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1470,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1471,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1472,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1473,                      /* -fm2-dump= */
  OPT_fm2_g = 1474,                          /* -fm2-g */
  OPT_fm2_lower_case = 1475,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1476,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1477,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1478,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1479,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1480,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1481,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1482,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1483,             /* -fmacro-prefix-map= */
  OPT_fmain = 1484,                          /* -fmain */
  OPT_fmath_errno = 1485,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1486,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1487,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1488,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1489,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1490,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1491,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1492,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1493,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1494,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1495,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1496,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1497,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1498,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1499,                          /* -fmod= */
  OPT_fmodule_file_ = 1500,                  /* -fmodule-file= */
  OPT_fmodule_header = 1501,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1502,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1503,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1504,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1505,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1506,                   /* -fmodule-only */
  OPT_fmodule_private = 1507,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1508,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1509,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1510,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1511,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1512,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1513,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1514,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1515,                 /* -fms-extensions */
  OPT_fmudflap = 1516,                       /* -fmudflap */
  OPT_fmudflapir = 1517,                     /* -fmudflapir */
  OPT_fmudflapth = 1518,                     /* -fmudflapth */
  OPT_fmultiflags = 1519,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1520,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1521,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1522,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1523,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1524,                  /* -fnext-runtime */
  OPT_fnil = 1525,                           /* -fnil */
  OPT_fnil_receivers = 1526,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1527,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1528,           /* -fno-inline-stringops */
  OPT_fno_modules = 1529,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1530,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1531,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1532,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1533,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1534,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1535,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1536,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1537,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1538,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1539,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1540,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1541,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1542,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1543,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1544,              /* -foffload-options= */
  OPT_foffload_ = 1545,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1546,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1547,                         /* -fonly= */
  OPT_fopenacc = 1548,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1549,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1550,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1551,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1552,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1553, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1554,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1555,                /* -foperator-names */
  OPT_fopt_info = 1556,                      /* -fopt-info */
  OPT_fopt_info_ = 1557,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1558, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1559,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1560,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1561, */          /* -foptional-diags */
  OPT_fpack_derived = 1562,                  /* -fpack-derived */
  OPT_fpack_struct = 1563,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1564,                  /* -fpack-struct= */
  OPT_fpad_source = 1565,                    /* -fpad-source */
  OPT_fpartial_inlining = 1566,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1567,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1568,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1569,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1570,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1571,                    /* -fpeel-loops */
  OPT_fpeephole = 1572,                      /* -fpeephole */
  OPT_fpeephole2 = 1573,                     /* -fpeephole2 */
  OPT_fpermissive = 1574,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1575,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1576,                           /* -fpic */
  OPT_fpie = 1577,                           /* -fpie */
  OPT_fpim = 1578,                           /* -fpim */
  OPT_fpim2 = 1579,                          /* -fpim2 */
  OPT_fpim3 = 1580,                          /* -fpim3 */
  OPT_fpim4 = 1581,                          /* -fpim4 */
  OPT_fplan9_extensions = 1582,              /* -fplan9-extensions */
  OPT_fplt = 1583,                           /* -fplt */
  OPT_fplugin_arg_ = 1584,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1585,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1586,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1587,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1588,                /* -fpostconditions */
  OPT_fpre_include_ = 1589,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1590,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1591,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1592,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1593,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1594,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1595,              /* -fpretty-templates */
  OPT_fpreview_all = 1596,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1597,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1598,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1599,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1600,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1601,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1602,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1603,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1604,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1605,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1606,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1607,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1608,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1609,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1610,           /* -fprintf-return-value */
  OPT_fprofile = 1611,                       /* -fprofile */
  OPT_fprofile_abs_path = 1612,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1613,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1614,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1615,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1616,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1617,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1618,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1619,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1620,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1621,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1622,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1623,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1624,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1625,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1626,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1627,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1628,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1629,               /* -fprofile-update= */
  OPT_fprofile_use = 1630,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1631,                  /* -fprofile-use= */
  OPT_fprofile_values = 1632,                /* -fprofile-values */
  OPT_fprotect_parens = 1633,                /* -fprotect-parens */
  OPT_fpthread = 1634,                       /* -fpthread */
  OPT_fq = 1635,                             /* -fq */
  OPT_frandom_seed = 1636,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1637,                  /* -frandom-seed= */
  OPT_frange = 1638,                         /* -frange */
  OPT_frange_check = 1639,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1640,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1641,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1642,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1643,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1644,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1645,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1646,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1647,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1648,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1649,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1650,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1651,               /* -frecord-marker=8 */
  OPT_frecursive = 1652,                     /* -frecursive */
  OPT_free = 1653,                           /* -free */
  /* OPT_freg_struct_return = 1654, */       /* -freg-struct-return */
  /* OPT_fregmove = 1655, */                 /* -fregmove */
  OPT_frelease = 1656,                       /* -frelease */
  OPT_frename_registers = 1657,              /* -frename-registers */
  OPT_freorder_blocks = 1658,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1659,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1660,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1661,             /* -freorder-functions */
  OPT_frepack_arrays = 1662,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1663,          /* -freplace-objc-classes */
  OPT_frepo = 1664,                          /* -frepo */
  OPT_freport_bug = 1665,                    /* -freport-bug */
  OPT_frequire_return_statement = 1666,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1667,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1668, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1669,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1670,                   /* -fresolution= */
  OPT_freturn = 1671,                        /* -freturn */
  OPT_frevert_all = 1672,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1673,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1674,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1675,             /* -frevert=intpromote */
  OPT_frounding_math = 1676,                 /* -frounding-math */
  OPT_frtti = 1677,                          /* -frtti */
  OPT_fruntime_modules_ = 1678,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1679,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1680,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1681,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1682,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1683,                   /* -frust-crate= */
  OPT_frust_debug = 1684,                    /* -frust-debug */
  OPT_frust_dump_ = 1685,                    /* -frust-dump- */
  OPT_frust_edition_ = 1686,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1687,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1688,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1689,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1690,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1691,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1692,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1693,      /* -frust-name-resolution-2.0 */
  OPT_fsanitize_address_use_after_scope = 1694,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1695,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1696,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1697,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1698,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1699,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1700,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1701, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1702,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1703,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1704,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1705,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1706,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1707,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1708,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1709,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1710, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1711,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1712,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1713,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1714,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1715,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1716,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1717,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1718,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1719,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1720,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1721,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1722,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1723,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1724,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1725,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1726,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1727, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1728,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1729,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1730,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1731,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1732,               /* -fsection-anchors */
  /* OPT_fsee = 1733, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1734,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1735,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1736,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1737,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1738,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1739,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1740,        /* -fsemantic-interposition */
  OPT_fshared = 1741,                        /* -fshared */
  OPT_fshort_enums = 1742,                   /* -fshort-enums */
  OPT_fshort_wchar = 1743,                   /* -fshort-wchar */
  OPT_fshow_column = 1744,                   /* -fshow-column */
  OPT_fshrink_wrap = 1745,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1746,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1747,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1748,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1749,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1750,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1751,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1752,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1753,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1754,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1755,                /* -fsoft-check-all */
  OPT_fsources = 1756,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1757,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1758,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1759,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1760,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1761,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1762,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1763,                      /* -fsquangle */
  OPT_fssa_backprop = 1764,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1765,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1766,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1767,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1768, */             /* -fstack-check */
  OPT_fstack_check_ = 1769,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1770,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1771,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1772,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1773,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1774,               /* -fstack-protector */
  OPT_fstack_protector_all = 1775,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1776,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1777,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1778,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1779,                   /* -fstack-usage */
  OPT_fstats = 1780,                         /* -fstats */
  OPT_fstdarg_opt = 1781,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1782,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1783, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1784,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1785,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1786, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1787,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1788,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1789,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1790,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1791, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1792,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1793,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1794,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1795,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1796,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1797,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1798,                  /* -fstrub=strict */
  OPT_fswig = 1799,                          /* -fswig */
  OPT_fswitch_errors = 1800,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1801,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1802,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1803,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1804, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1805,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1806, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1807,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1808, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1809,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1810,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1811,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1812,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1813,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1814,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1815,                   /* -ftime-report */
  OPT_ftime_report_details = 1816,           /* -ftime-report-details */
  OPT_ftls_model_ = 1817,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1818,              /* -ftoplevel-reorder */
  OPT_ftracer = 1819,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1820,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1821,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1822,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1823,                   /* -ftrampolines */
  OPT_ftransition_all = 1824,                /* -ftransition=all */
  OPT_ftransition_field = 1825,              /* -ftransition=field */
  OPT_ftransition_in = 1826,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1827,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1828,          /* -ftransition=templates */
  OPT_ftransition_tls = 1829,                /* -ftransition=tls */
  OPT_ftrapping_math = 1830,                 /* -ftrapping-math */
  OPT_ftrapv = 1831,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1832,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1833,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1834,                      /* -ftree-ccp */
  OPT_ftree_ch = 1835,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1836, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1837,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1838,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1839, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1840,                   /* -ftree-cselim */
  OPT_ftree_dce = 1841,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1842,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1843,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1844,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1845,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1846, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1847,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1848,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1849, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1850,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1851,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1852, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1853,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1854,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1855,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1856,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1857,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1858,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1859,                      /* -ftree-pre */
  OPT_ftree_pta = 1860,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1861,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1862, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1863,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1864,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1865,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1866,                     /* -ftree-slsr */
  OPT_ftree_sra = 1867,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1868, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1869, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1870,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1871,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1872,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1873, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1874,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1875, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1876,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1877,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1878,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1879,         /* -funconstrained-commons */
  OPT_funderscoring = 1880,                  /* -funderscoring */
  OPT_funit_at_a_time = 1881,                /* -funit-at-a-time */
  OPT_funittest = 1882,                      /* -funittest */
  OPT_funreachable_traps = 1883,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1884,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1885,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1886,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1887, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1888,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1889,                      /* -funsigned */
  OPT_funsigned_bitfields = 1890,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1891,                 /* -funsigned-char */
  OPT_funswitch_loops = 1892,                /* -funswitch-loops */
  OPT_funwind_tables = 1893,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1894,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1895,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1896,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1897,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1898,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1899,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1900,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1901,                     /* -fuse-list= */
  OPT_fvar_tracking = 1902,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1903,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1904,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1905,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1906,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1907, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1908,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1909,                   /* -fverbose-asm */
  /* OPT_fversion = 1910, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1911,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1912,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1913,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1914,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1915,                   /* -fvisibility= */
  OPT_fvpt = 1916,                           /* -fvpt */
  OPT_fvtable_gc = 1917,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1918,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1919,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1920,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1921,                     /* -fvtv-debug */
  OPT_fweak = 1922,                          /* -fweak */
  OPT_fweak_templates = 1923,                /* -fweak-templates */
  OPT_fweb = 1924,                           /* -fweb */
  /* OPT_fwhole_file = 1925, */              /* -fwhole-file */
  OPT_fwhole_program = 1926,                 /* -fwhole-program */
  OPT_fwholediv = 1927,                      /* -fwholediv */
  OPT_fwholevalue = 1928,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1929,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1930,             /* -fworking-directory */
  OPT_fwpa = 1931,                           /* -fwpa */
  OPT_fwpa_ = 1932,                          /* -fwpa= */
  OPT_fwrapv = 1933,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1934,                 /* -fwrapv-pointer */
  OPT_fxref = 1935,                          /* -fxref */
  /* OPT_fzee = 1936, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1937,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1938,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1939,                     /* -fzero-link */
  OPT_g = 1940,                              /* -g */
  OPT_gant = 1941,                           /* -gant */
  OPT_gas_loc_support = 1942,                /* -gas-loc-support */
  OPT_gas_locview_support = 1943,            /* -gas-locview-support */
  OPT_gbtf = 1944,                           /* -gbtf */
  OPT_gcodeview = 1945,                      /* -gcodeview */
  OPT_gcoff = 1946,                          /* -gcoff */
  OPT_gcoff1 = 1947,                         /* -gcoff1 */
  OPT_gcoff2 = 1948,                         /* -gcoff2 */
  OPT_gcoff3 = 1949,                         /* -gcoff3 */
  OPT_gcolumn_info = 1950,                   /* -gcolumn-info */
  OPT_gctf = 1951,                           /* -gctf */
  OPT_gdescribe_dies = 1952,                 /* -gdescribe-dies */
  OPT_gdwarf = 1953,                         /* -gdwarf */
  OPT_gdwarf_ = 1954,                        /* -gdwarf- */
  OPT_gdwarf32 = 1955,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1956,                       /* -gdwarf64 */
  OPT_gen_decls = 1957,                      /* -gen-decls */
  OPT_ggdb = 1958,                           /* -ggdb */
  OPT_ggnu_pubnames = 1959,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1960,                   /* -gimple-stats */
  OPT_ginline_points = 1961,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1962, /* -ginternal-reset-location-views */
  OPT_gnat = 1963,                           /* -gnat */
  OPT_gnatO = 1964,                          /* -gnatO */
  OPT_gno_ = 1965,                           /* -gno- */
  OPT_gno_pubnames = 1966,                   /* -gno-pubnames */
  OPT_gprune_btf = 1967,                     /* -gprune-btf */
  OPT_gpubnames = 1968,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1969,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1970,                   /* -gsplit-dwarf */
  OPT_gstabs = 1971,                         /* -gstabs */
  OPT_gstabs_ = 1972,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1973,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1974,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1975,                        /* -gtoggle */
  OPT_gvariable_location_views = 1976,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1977,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1978,                           /* -gvms */
  OPT_gxcoff = 1979,                         /* -gxcoff */
  OPT_gxcoff_ = 1980,                        /* -gxcoff+ */
  OPT_gz = 1981,                             /* -gz */
  OPT_gz_ = 1982,                            /* -gz= */
  OPT_h = 1983,                              /* -h */
  OPT_help = 1984,                           /* -help */
  OPT_idirafter = 1985,                      /* -idirafter */
  OPT_imacros = 1986,                        /* -imacros */
  OPT_imultiarch = 1987,                     /* -imultiarch */
  OPT_imultilib = 1988,                      /* -imultilib */
  OPT_include = 1989,                        /* -include */
  OPT_iplugindir_ = 1990,                    /* -iplugindir= */
  OPT_iprefix = 1991,                        /* -iprefix */
  OPT_iquote = 1992,                         /* -iquote */
  OPT_isysroot = 1993,                       /* -isysroot */
  OPT_isystem = 1994,                        /* -isystem */
  OPT_iwithprefix = 1995,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1996,              /* -iwithprefixbefore */
  OPT_k8 = 1997,                             /* -k8 */
  OPT_l = 1998,                              /* -l */
  OPT_lang_asm = 1999,                       /* -lang-asm */
  OPT_list = 2000,                           /* -list */
  OPT_mabi_ = 2001,                          /* -mabi= */
  OPT_march_ = 2002,                         /* -march= */
  OPT_mbig_endian = 2003,                    /* -mbig-endian */
  OPT_mbionic = 2004,                        /* -mbionic */
  OPT_mbranch_protection_ = 2005,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2006,                       /* -mcmodel= */
  OPT_mcpu_ = 2007,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2008,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2009,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2010,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2011,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2012,             /* -mgeneral-regs-only */
  OPT_mglibc = 2013,                         /* -mglibc */
  OPT_mharden_sls_ = 2014,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2015,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2016,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2017,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2018,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2019,            /* -mlow-precision-sqrt */
  OPT_mmusl = 2020,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 2021,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2022,               /* -moutline-atomics */
  OPT_moverride_ = 2023,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2024,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2025,          /* -msign-return-address= */
  ...
  OPT_msve_vector_bits_ = 2030,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2031,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2032,                     /* -mtls-size= */
  OPT_mtp_ = 2033,                           /* -mtp= */
  OPT_mtrack_speculation = 2034,             /* -mtrack-speculation */
  OPT_mtune_ = 2035,                         /* -mtune= */
  OPT_muclibc = 2036,                        /* -muclibc */
  OPT_mverbose_cost_dump = 2037,             /* -mverbose-cost-dump */
  OPT_n = 2038,                              /* -n */
  ...
  OPT_pie = 2059,                            /* -pie */
  OPT_pipe = 2060,                           /* -pipe */
  OPT_posix = 2061,                          /* -posix */
  OPT_print_file_name_ = 2062,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2063,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2064,          /* -print-multi-directory */
  OPT_print_multi_lib = 2065,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2066,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2067,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2068,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2069,               /* -print-prog-name= */
  OPT_print_search_dirs = 2070,              /* -print-search-dirs */
  ...
  OPT_profile = 2074,                        /* -profile */
  OPT_pthread = 2075,                        /* -pthread */
  OPT_quiet = 2076,                          /* -quiet */
  OPT_r = 2077,                              /* -r */
  OPT_rdynamic = 2078,                       /* -rdynamic */
  OPT_remap = 2079,                          /* -remap */
  OPT_reverse_sort = 2080,                   /* -reverse-sort */
  OPT_s = 2081,                              /* -s */
  OPT_save_temps = 2082,                     /* -save-temps */
  OPT_save_temps_ = 2083,                    /* -save-temps= */
  OPT_shared = 2084,                         /* -shared */
  OPT_shared_libgcc = 2085,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2086,               /* -shared-libphobos */
  OPT_size_sort = 2087,                      /* -size-sort */
  /* OPT_specs = 2088, */                    /* -specs */
  OPT_specs_ = 2089,                         /* -specs= */
  OPT_static = 2090,                         /* -static */
  OPT_static_libasan = 2091,                 /* -static-libasan */
  OPT_static_libgcc = 2092,                  /* -static-libgcc */
  OPT_static_libgfortran = 2093,             /* -static-libgfortran */
  OPT_static_libgm2 = 2094,                  /* -static-libgm2 */
  OPT_static_libgo = 2095,                   /* -static-libgo */
  OPT_static_libhwasan = 2096,               /* -static-libhwasan */
  OPT_static_liblsan = 2097,                 /* -static-liblsan */
  OPT_static_libmpx = 2098,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2099,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2100,               /* -static-libphobos */
  OPT_static_libquadmath = 2101,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2102,               /* -static-libstdc++ */
  OPT_static_libtsan = 2103,                 /* -static-libtsan */
  OPT_static_libubsan = 2104,                /* -static-libubsan */
  OPT_static_pie = 2105,                     /* -static-pie */
  /* OPT_std_c__03 = 2106, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2107, */                /* -std=c++0x */
  OPT_std_c__11 = 2108,                      /* -std=c++11 */
  OPT_std_c__14 = 2109,                      /* -std=c++14 */
  OPT_std_c__17 = 2110,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2111, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2112, */                /* -std=c++1z */
  OPT_std_c__20 = 2113,                      /* -std=c++20 */
  OPT_std_c__23 = 2114,                      /* -std=c++23 */
  OPT_std_c__26 = 2115,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2116, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2117, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2118, */                /* -std=c++2c */
  OPT_std_c__98 = 2119,                      /* -std=c++98 */
  OPT_std_c11 = 2120,                        /* -std=c11 */
  OPT_std_c17 = 2121,                        /* -std=c17 */
  /* OPT_std_c18 = 2122, */                  /* -std=c18 */
  /* OPT_std_c1x = 2123, */                  /* -std=c1x */
  OPT_std_c23 = 2124,                        /* -std=c23 */
  /* OPT_std_c2x = 2125, */                  /* -std=c2x */
  OPT_std_c2y = 2126,                        /* -std=c2y */
  /* OPT_std_c89 = 2127, */                  /* -std=c89 */
  OPT_std_c90 = 2128,                        /* -std=c90 */
  OPT_std_c99 = 2129,                        /* -std=c99 */
  /* OPT_std_c9x = 2130, */                  /* -std=c9x */
  OPT_std_f2003 = 2131,                      /* -std=f2003 */
  OPT_std_f2008 = 2132,                      /* -std=f2008 */
  OPT_std_f2008ts = 2133,                    /* -std=f2008ts */
  OPT_std_f2018 = 2134,                      /* -std=f2018 */
  OPT_std_f2023 = 2135,                      /* -std=f2023 */
  OPT_std_f95 = 2136,                        /* -std=f95 */
  OPT_std_gnu = 2137,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2138, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2139, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2140,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2141,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2142,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2143, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2144, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2145,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2146,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2147,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2148, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2149, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2150, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2151,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2152,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2153,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2154, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2155, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2156,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2157, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2158,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2159, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2160,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2161,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2162, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2163, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2164,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2165, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2166, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2167, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2168, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2169, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2170, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2171,                     /* -std=legacy */
  OPT_stdlib_ = 2172,                        /* -stdlib= */
  OPT_symbol_ = 2173,                        /* -symbol= */
  OPT_symbolic = 2174,                       /* -symbolic */
  OPT_t = 2175,                              /* -t */
  OPT_time = 2176,                           /* -time */
  OPT_time_ = 2177,                          /* -time= */
  OPT_traditional = 2178,                    /* -traditional */
  OPT_traditional_cpp = 2179,                /* -traditional-cpp */
  OPT_tree_stats = 2180,                     /* -tree-stats */
  OPT_trigraphs = 2181,                      /* -trigraphs */
  OPT_truncate = 2182,                       /* -truncate */
  OPT_type_stats = 2183,                     /* -type-stats */
  OPT_u = 2184,                              /* -u */
  OPT_undef = 2185,                          /* -undef */
  OPT_v = 2186,                              /* -v */
  OPT_version = 2187,                        /* -version */
  OPT_w = 2188,                              /* -w */
  OPT_wrapper = 2189,                        /* -wrapper */
  OPT_x = 2190,                              /* -x */
  OPT_z = 2191,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
